...
def main():
    ...
    with open("Exp_1/link_utilization_128_64_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
    ...
    with open("Exp_2/link_utilization_128_64_16.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    with open("Exp_3/link_utilization_128_64_32.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    with open("Exp_4/link_utilization_128_64_64.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    with open("Exp_5/link_utilization_128_64_128.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    ax1.legend(["Random Rules Num = 16","Random Rules Num = 32"])
