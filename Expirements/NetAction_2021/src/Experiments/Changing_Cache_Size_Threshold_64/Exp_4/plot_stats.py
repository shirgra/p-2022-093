...
def main():
    ...
    with open("Deletions_32_64_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
    ...
    with open("Insertions_32_64_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    with open("link_utilization_32_64_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    with open("traffic_arrival_rate_32_64_8.txt",'r') as file:
        for line in file:
            new_line = line[:-1]
            new_line = new_line[1:-1]
            new_line = new_line.split(",")
    ...
    print("Average Link Utilization is: ")
    LU_avg = sum(data_list_LU)/len(data_list_LU)
    print(LU_avg)
    print("Average Traffic arrival rate is: ")
    AR_avg = sum(data_list_AR)/len(data_list_AR)
    print(AR_avg)
    print("Miss rate Percentage is: ")
    print((LU_avg/AR_avg)*100)
    ...
    ax1.legend(["Controller-Switch Link Utilization","Traffic Arrival Rate"])
    # set x-axis label
    ax1.set_xlabel("Simulation Time",fontsize=14)
    # set y-axis label
    ax1.set_ylabel("Packets",fontsize=14)
    # make a plot
    #ax3=ax1.twinx()
