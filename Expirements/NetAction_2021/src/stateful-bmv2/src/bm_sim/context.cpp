...
template std::vector<FlowTable::Entry>
Context::mt_get_entries<FlowTable>(const std::string &) const;
...
template MatchErrorCode
Context::mt_get_entry<FlowTable>(
    const std::string &, entry_handle_t, FlowTable::Entry *) const;
...
template MatchErrorCode
Context::mt_get_entry_from_key<FlowTable>(
        const std::string &, const std::vector<MatchKeyParam> &,
        FlowTable::Entry *, int) const;
template MatchErrorCode
