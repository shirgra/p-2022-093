...
void
ActionFn::parameter_push_back_register_stack(RegisterStack *register_stack) {
  ActionParam param;
  param.tag = ActionParam::REGISTER_STACK;
  param.register_stack = register_stack;
  params.push_back(param);

  register_sync.add_register_array(register_stack);
}
