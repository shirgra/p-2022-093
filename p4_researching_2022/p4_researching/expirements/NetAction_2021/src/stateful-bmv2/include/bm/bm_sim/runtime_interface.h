...
class RuntimeInterface {
 ...
 public:
  ...
  virtual std::vector<FlowTable::Entry>
  mt_st_get_entries(cxt_id_t cxt_id, const std::string &table_name) const = 0;
  ...
  mt_st_get_entry(cxt_id_t cxt_id, const std::string &table_name,
               entry_handle_t handle, FlowTable::Entry *entry) const = 0;
  ...
  mt_st_get_entry_from_key(cxt_id_t cxt_id, const std::string &table_name,
                        const std::vector<MatchKeyParam> &match_key,
                        FlowTable::Entry *entry, int priority = 1) const = 0;
