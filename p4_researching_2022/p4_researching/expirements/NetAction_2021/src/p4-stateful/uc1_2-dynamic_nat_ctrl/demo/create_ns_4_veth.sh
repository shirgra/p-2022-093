...
ip netns exec wan ip a a 160.80.10.1/24 dev veth3
ip netns exec wan ip r a 1.1.1.1/32 dev veth3
ip netns exec lan ip r a 160.80.10.1/32 dev veth0

ip netns exec lan arp -s 160.80.10.1 12:12:12:22:22:22
ip netns exec wan arp -s 1.1.1.1 12:12:12:11:11:11
...
ip netns exec lan sysctl -w net.ipv6.conf.all.disable_ipv6=1
ip netns exec lan sysctl -w net.ipv6.conf.default.disable_ipv6=1

ip netns exec wan sysctl -w net.ipv6.conf.all.disable_ipv6=1
ip netns exec wan sysctl -w net.ipv6.conf.default.disable_ipv6=1
